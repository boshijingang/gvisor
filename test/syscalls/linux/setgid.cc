...
constexpr int dirmode_sgid = S_ISGID | 0777;
constexpr int dirmode_noexec = S_ISGID | 0767;
constexpr int dirmode_nosgid = 0777;
...
TEST(SetgidDirTest, WriteToFile) {
  ...
  struct testcase testcases[] = {
      ...
      {"setuid", S_ISUID | 0777, 00777},
      {"setgid", S_ISGID | 0777, 00777},
      {"setuid and setgid", S_ISUID | S_ISGID | 0777, 00777},
      {"setgid without exec", S_ISGID | 0767, S_ISGID | 0767},
      {"setuid and setgid without exec", S_ISGID | S_ISUID | 0767,
       S_ISGID | 0767}};
